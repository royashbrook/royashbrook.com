...
date: 2019-02-05
path: "2019/02/05/watching-a-folder-for-changes-and-sending-an-email-with-powershell"
---

I [previously wrote](/2018/07/24/watching-files-with-powershell/) about watching a folder for changes and displaying some information on those changes. This was primarily used for some live monitoring of a file mover that was being sunset.
...
<script src="https://gist.github.com/royashbrook/bf8419a82dbc6de5c4a7b160256d446b.js?file=watchfolder.ps1"></script>

Script I currently use to just notify myself via email to text when a file was created, aka, the event started:

<script src="https://gist.github.com/royashbrook/bf8419a82dbc6de5c4a7b160256d446b.js?file=notify.ps1"></script>
